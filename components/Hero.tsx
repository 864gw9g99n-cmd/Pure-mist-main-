...
export default function Hero() {
  return (
    <section className="relative min-h-screen-safe w-full flex items-center justify-center overflow-hidden bg-gradient-to-b from-emerald-dark via-midnight to-black pt-16">
      ...
      <div className="relative max-w-4xl mx-auto px-4 sm:px-6 text-center animate-fadeIn flex flex-col items-center gap-8">
        <PerfumeSprayHero />
        ...
        <div>
          ...
          <p className="text-neutral-300 max-w-xl mx-auto text-sm sm:text-base leading-relaxed">
