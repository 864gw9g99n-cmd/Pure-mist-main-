...
export default function CheckoutFlow({ open, onClose }: { open: boolean; onClose: () => void }) {
  ...
  return (
    <>
      ...
      <div
        className={`fixed inset-0 bg-black/70 z-[80] transition-opacity ${
      ...
      <div
        className={`fixed top-0 right-0 h-full w-full sm:w-[420px] max-w-full z-[90] bg-midnight border-l border-gold/20 shadow-2xl transition-transform duration-300 overflow-y-auto safe-top safe-bottom ${
